= ISMS-Management
:doctype: article
:description: Der Informationssicherheitsbauftragte übernimmt das ISMS-Management und steuert darüber die Informationssicherheit der Organisation
:keywords: ISMS, ISO 27k, ISMS-Management
:icons: font
...
video::anwendbarkeitserklaerung.mp4[width=950]
...
video::aufgaben_diagramme.mp4[width=950]
